...
namespace BlueSun.Data.Migrations
{
    ...
    [Migration("20220405155703_WalletBalanceColumnNewMax")]
    partial class WalletBalanceColumnNewMax
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueSun.Data.Models.Artist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlueSun.Data.Models.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlueSun.Data.Models.Artist", b =>
                {
                    b.HasOne("BlueSun.Data.Models.User", null)
                        .WithOne()
                        .HasForeignKey("BlueSun.Data.Models.Artist", "UserId")
            ...
            modelBuilder.Entity("BlueSun.Data.Models.NFT", b =>
                {
                    ...
                    b.HasOne("BlueSun.Data.Models.User", "Owner")
                        .WithMany("NFTs")
            ...
            modelBuilder.Entity("BlueSun.Data.Models.NFTCollection", b =>
                {
                    b.HasOne("BlueSun.Data.Models.Artist", "Artist")
            ...
            modelBuilder.Entity("BlueSun.Data.Models.Wallet", b =>
                {
                    b.HasOne("BlueSun.Data.Models.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("BlueSun.Data.Models.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
